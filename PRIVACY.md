...
- Saved notes remain until you delete them or remove/clear the extension's data. The extension keeps up to 500 notes.
...
- Import validates and merges the file with existing notes, skips duplicates,
  ...
  note ID or a merged total above 500 rejects the entire import. A failed import
